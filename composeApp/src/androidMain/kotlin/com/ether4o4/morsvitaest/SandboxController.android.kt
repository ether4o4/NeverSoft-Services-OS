...
import com.ether4o4.morsvitaest.sandbox.SessionShell
import com.ether4o4.morsvitaest.sandbox.openFileWithIntent
import com.ether4o4.morsvitaest.sandbox.resolveSandboxAbsolute
...
class AndroidSandboxController : SandboxController {
    ...
    override fun transcriptFor(sessionId: String): SnapshotStateList<com.ether4o4.morsvitaest.TerminalLine> = sandboxManager.transcriptFor(sessionId)
