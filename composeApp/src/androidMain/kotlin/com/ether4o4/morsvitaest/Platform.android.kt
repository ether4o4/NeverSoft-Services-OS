...
import com.ether4o4.morsvitaest.sms.declaresReadSms
import com.ether4o4.morsvitaest.tools.CalendarPermissionController
import com.ether4o4.morsvitaest.tools.CalendarRepository
import com.ether4o4.morsvitaest.tools.CalendarResult
...
import com.ether4o4.morsvitaest.tools.NotificationHelper
import com.ether4o4.morsvitaest.tools.NotificationPermissionController
import com.ether4o4.morsvitaest.tools.NotificationResult
import com.ether4o4.morsvitaest.tools.NotificationTools
import com.ether4o4.morsvitaest.tools.OpenFileTool
...
import com.ether4o4.morsvitaest.tools.SmsTools
import com.ether4o4.morsvitaest.tools.SshConfigureHostTool
import com.ether4o4.morsvitaest.tools.WebSearchTool
...
import morsvitaest.composeapp.generated.resources.tool_open_file_description
import morsvitaest.composeapp.generated.resources.tool_open_file_name
import morsvitaest.composeapp.generated.resources.tool_send_notification_description
...
actual fun createSecureSettings(): Settings {
    ...
    return try {
        ...
        context.deleteSharedPreferences("morsvitaest_secure_prefs")
        SharedPreferencesSettings(createEncryptedPrefs(context))
    }
}
...
actual fun createLegacySettings(): Settings? {
    val context: Context by inject(Context::class.java)
    val prefs = context.getSharedPreferences("com.ether4o4.morsvitaest_preferences", Context.MODE_PRIVATE)
            ...
            add(
                object : Tool {
                    ...
                    override suspend fun execute(args: Map<String, Any>): Any {
                        val title = args["title"] as? String ?: "MorsVitaEst"
