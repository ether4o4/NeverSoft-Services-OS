...
data class SettingsActions(
    ...
    val onMoveServiceUp: (String) -> Unit,
    val onMoveServiceDown: (String) -> Unit,
    val onToggleServiceEnabled: (String, Boolean) -> Unit,
    val onCreateProject: (String, String, List<com.ether4o4.morsvitaest.data.ProjectDocument>) -> Unit,
    val onUpdateProject: (String, String, String, List<com.ether4o4.morsvitaest.data.ProjectDocument>) -> Unit,
    val onDeleteProject: (String) -> Unit,
    val onSelectActiveProject: (String) -> Unit,
    ...
    val onChangeDailyTokenBudget: (Long) -> Unit,
    val onTogglePauseAutonomousOnBreach: (Boolean) -> Unit,
    val onToggleAutonomousPaused: (Boolean) -> Unit,
    val onResetBudgetUsage: () -> Unit,
    ...
    companion object {
        val NoOp = SettingsActions(
            ...
            onMoveServiceUp = {},
            onMoveServiceDown = {},
            onToggleServiceEnabled = { _, _ -> },
            onCreateProject = { _, _, _ -> },
            onUpdateProject = { _, _, _, _ -> },
            onDeleteProject = {},
            ...
            onRefreshHeartbeat = {},
            onChangeDailyTokenBudget = {},
            onTogglePauseAutonomousOnBreach = {},
            onToggleAutonomousPaused = {},
            onResetBudgetUsage = {},
            onToggleEmail = {},
