...
kotlin {
    androidLibrary {
        namespace = "com.ether4o4.morsvitaest.shared"
        compileSdk =
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            ...
            binaryOption("bundleId", "com.ether4o4.morsvitaest.composeapp")
        }
    }
...
compose.desktop {
    application {
        mainClass = "com.ether4o4.morsvitaest.MainKt"
...
class VersionGeneratorPlugin : Plugin<Project> {
    override fun apply(project: Project) {
        project.afterEvaluate {
            ...
            val versionFile =
                layout.buildDirectory
                    .file("generated/src/commonMain/kotlin/com/ether4o4/morsvitaest/Version.kt")
                    .get()
                    .asFile
